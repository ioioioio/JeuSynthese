...
const float ModeleItem::sommets[]{ // copi�-coll� de https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/6.multiple_lights/multiple_lights.cpp
...
const int ModeleItem::indices[]{ //copi�-coll� modifi� de http://learningwebgl.com/lessons/lesson06/index.html
	0, 2, 1,      0, 3, 2,
	4, 5, 6,      4, 6, 7,
	8, 9, 10,     8, 10, 11,
	12, 14, 13,   12, 15, 14,
...
{
	//Les donn�es des sommets doivent �tre inscrites dans cet ordre: positions, normales, texture
