...
// copier-coll� de https://learnopengl.com/#!In-Practice/Text-Rendering
	...
	: projection(glm::ortho(0.0f, static_cast<GLfloat>(largeur_fenetre), 0.0f, static_cast<GLfloat>(hauteur_fenetre)))
{
	...
	// Load font as face
	FT_Face face;
	if (FT_New_Face(ft, "fonts/BBrick.ttf", 0, &face))
		std::cout << "ERROR::FREETYPE: Failed to load font" << std::endl;

	// Set size to load glyphs as
	FT_Set_Pixel_Sizes(face, 0, static_cast<FT_UInt>(hauteur_fenetre*0.08));
...
void TextRendering::RenderText(std::string text, glm::vec2 position, GLfloat scale, glm::vec3 color)
{
